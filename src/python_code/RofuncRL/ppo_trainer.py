...
if __name__ == '__main__':
    ...
    cenv = ClothEnv()
    cfg = get_config('../../../../../../../../GitHub/DiffCloth/src/python_code','ClothPPO.yaml')
    # bt = BaseTrainer(cfg, cenv, device=None, env_name=None, inference=True)
    ppot = PPOTrainer(cfg, cenv, device=None, env_name=None)