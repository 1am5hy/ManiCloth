...
def train(custom_args):
    ...
    args_overrides = ["task={}".format(task),
                      "train={}{}".format(task, custom_args.agent.upper()),
    ...
    "Input npy reference"
    cfg.task.env.motion_file = '/home/ubuntu/Github/DiffCloth/src/python_code/real2sim/optitrack_data/npfiles/marker_path_dyndemo.npy'
    cfg_dict = omegaconf_to_dict(cfg.task)

    set_seed(cfg.train.Trainer.seed)

    # Instantiate the Isaac Gym environment
    env = ClothHang(cfg=cfg_dict,
