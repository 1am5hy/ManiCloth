...
def run_sim_visualize(step_num):
    ...
    scene.customAttachmentVertexIdx = [(0, [0, 7, 14, 48, 120, 132, 188, 255, 262, 269])]
    ...
    position_control = np.load('/home/ubuntu/Github/DiffCloth/src/python_code/DataSort/npfiles/marker_table_new_3.npy')
...
def run_result(step_num):
    ...
    # sim.resetSystem()
    paramInfo = dfc.ParamInfo()
    x = np.load('/home/ubuntu/Github/DiffCloth/src/python_code/DataSort/npfiles/x_init_table_new.npy')
    ...
    position_control = np.load('/home/ubuntu/Github/DiffCloth/src/python_code/DataSort/npfiles/gp_table_new.npy')
...
if __name__=="__main__":
    array = np.load("/home/ubuntu/Github/DiffCloth/src/python_code/DataSort/npfiles/marker_real_table_30.npy")[0]
    # x, v = run_result(130)
    # x, v = run_sim_visualize(140)
    x, v = run_sim_target(450, array)
    ...
    x = np.array(x[-1])
    np.save("/home/ubuntu/Github/DiffCloth/src/python_code/DataSort/npfiles/x_init_real_table.npy", x)
