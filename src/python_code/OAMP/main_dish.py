...
from task_dish import ClothDishTask
from env_dish import cloth_env
...
def train(custom_args):
    ...
    env = ClothDishTask(cfg=omegaconf_to_dict(cfg.task),
...
if __name__ == '__main__':
    ...
    parser.add_argument("--task", type=str, default="ClothDish")
