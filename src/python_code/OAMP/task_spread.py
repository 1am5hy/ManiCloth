...
class ClothSpreadTask(gym.Env):
    def __init__(self, cfg, sim_device, cloth_env):
        ...
        # self.action_space1 = Box(-1, 1, (3,))
        # self.action_space2 = Box(-1, 1, (4,))

        self._num_amp_obs_steps = cfg["env"]["numAMPObsSteps"]
        self._num_amp_obs_per_step = 24   # Observed particles + tool pose
        # self._num_amp_obs_per_step = 6
        # self._num_amp_obs_per_step = 675
        self._num_amp_target_obs = 24  # Target particle states size
        ...
        motion_file = "/home/ubuntu/Github/DiffCloth/src/python_code/DataSort/npfiles/relative_marker_spread_24.npy"
