...
if __name__ == '__main__':
    ...
    parser.add_argument("--ckpt_path", type=str, default="/home/ubuntu/Github/DiffCloth/src/python_code/OAMP/runs/RofuncRL_ORKTrainer_ClothHang_24-02-26_07-07-34-426975/checkpoints/best_ckpt.pth")
