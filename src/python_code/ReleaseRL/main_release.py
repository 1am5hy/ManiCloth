...
from task_release import ClothRelease
from env_release import cloth_env
...
if __name__ == '__main__':
    ...
    parser.add_argument("--task", type=str, default="ClothRelease")
    ...
    parser.add_argument("--ckpt_path", type=str, default="/home/ubuntu/Github/DiffCloth/src/python_code/ReleaseRL/runs/RofuncRL_PPOTrainer_ClothRelease_24-02-23_11-10-09-945038/checkpoints/best_ckpt.pth")
