...
class Runner:
    ...
    def train(self):
        ...
        for epoch_i in tqdm(range(num_epochs)):
            ...
            position_control = np.load('/home/ubuntu/Github/DiffCloth/src/python_code/real2sim/optitrack_data/npfiles/gp_dyndemo.npy')
            ...
            markers = np.load('/home/ubuntu/Github/DiffCloth/src/python_code/real2sim/optitrack_data/npfiles/marker_path_dyndemo.npy')
            if len(markers) > 150:
                markers = markers[:150]
            ...
            # x = x * 2
            mar = markers.clone().detach()
            marker_part_loss = markers - part
            # print(marker_part_loss[75])
