...
from sim_for_table import SimDeform
...
class Runner:
    ...
    def train(self):
        ...
        for epoch_i in tqdm(range(num_epochs)):
            ...
            x_init = np.load("/home/ubuntu/Github/DiffCloth/src/python_code/DataSort/npfiles/x_init_table_task.npy")
            ...
            markers = np.load('/home/ubuntu/Github/DiffCloth/src/python_code/DataSort/npfiles/marker_table_task_3.npy')
            print(markers.shape)
            if len(markers) > 150:
                markers = markers[:150]
    ...
    def update_learning_rate(self, scale_factor=1):
        learning_factor = .9 ** (self.iter_step // 200)
