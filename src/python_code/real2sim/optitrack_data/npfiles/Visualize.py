...
fig = plt.figure()
ax = p3.Axes3D(fig)
ax.axes.set_xlim3d(left=-80, right=80)
ax.axes.set_ylim3d(bottom=-80, top=80)
ax.axes.set_zlim3d(bottom=20, top=120)

case1 = np.load("/home/ubuntu/Github/DiffCloth/src/python_code/real2sim/optitrack_data/npfiles/lifting.npy")
# case1 = case1 / 12
...
for i in range(no_of_particles):
    # print((3*i)+(10-no_of_particles)*3)
