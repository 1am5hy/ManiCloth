...
//    static AttachmentConfigs restPosConfiguration;
    ...
    Plane plane1, plane2, plane3, plane4, slope;
    Sphere slopeGoal;
...
//            Training pose 2
            rightLowerArm(Vec3d(-5.29989, 6.9629349, -0.285244), 0.22272, 7, Vec3d(0, 1, 0), Vec3d(0, 0, 1)),
//          Inference pose 1
...
//            rightLowerArm(Vec3d(-3.893591, 7.0981565, 0.2083674), 0.22272, 7, Vec3d(0, 1, 0), Vec3d(-0.34292087, -0.00287866, 0.93935988)),
            ...
            plane1(Vec3d(0, -0.5, 0), Vec3d(-100, -0.5, -100), Vec3d(100, -0.5, -100), COLOR_GRAY50),

            plane2(Vec3d(-6.25949, 6.141073, 0.8672467), Vec3d(-9.16133, 6.141073, -3.06233), Vec3d(-3.39524, 6.141073, -3.12073), COLOR_SKY),
//            plane3(Vec3d(-3.2929, 6.1616, 2.6338), Vec3d(-7.18447, 6.189293, -0.073747), Vec3d(0.44897, 6.174403, -0.289723), COLOR_SKY),
//Table for table task _ low table
//            plane3(Vec3d(-3.68522, 3.768829, 3.926864), Vec3d(-6.56042, 3.768829, 0.0349113), Vec3d(-0.79241, 3.768829, 0.0562581), COLOR_SKY),
//Table for table task _ low table 2
            plane3(Vec3d(-2.9311401, 2.8980389, 4.0472439), Vec3d(-5.7770855, 2.8980389, 0.1410076), Vec3d(-0.0228325, 2.8980389, 0.1990521), COLOR_SKY),
...
//            plane1(Vec3d(5, 5, 0), 0.15, 10, Vec3d(0, 1, 0), Vec3d(-1, 0, 0)),
//            slope(Vec3d(0, -11, 10), Vec3d(-8, -1, -1), Vec3d(8, -1, -1), COLOR_GRAY50),
            slope(Vec3d(0, 0, 0), Vec3d(-10, 0, -10), Vec3d(10, 0, -10), COLOR_GRAY50),
            printVerbose(true) {
